...
<html lang="en">
	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						<h2>Enter Your Farm Product Information here..!!</h2>
						<br>
				<center>
					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Fruit" style="color: black;">Crop</option>
								  <option value="Vegetable" style="color: black;">Animal</option>
			...
			<div class="row">
				<div class="col-sm-6">
					  <input type="text" name="price" id="price" value="" placeholder="Sum Invested" style="background-color:white;color: black;" />
				</div>
				<div class="col-sm-6">
